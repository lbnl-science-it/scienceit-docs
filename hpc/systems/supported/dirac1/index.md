...
DIRAC1 uses [One Time Password (OTP)](https://scienceit-docs.lbl.gov/hpc/accounts/mfa/index.md) for login authentication for all the services provided below.

- [Login server](https://scienceit-docs.lbl.gov/hpc/accounts/loggingin/index.md): `lrc-login.lbl.gov`
- [DATA transfer server](https://scienceit-docs.lbl.gov/hpc/data-transfer-node/index.md): `lrc-xfer.lbl.gov`
- [Globus Online endpoint](https://scienceit-docs.lbl.gov/data/globus/index.md): `lbnl#lrc`
