...
If you use jupyter server on [lrc-openondemand](https://scienceit-docs.lbl.gov/hpc/openondemand/overview/index.md), pytorch kernels `torch 2.0.1` and `torch 2.3.1` are available.
