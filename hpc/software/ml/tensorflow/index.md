...
If you use jupyter server on [lrc-openondemand](https://scienceit-docs.lbl.gov/hpc/openondemand/overview/index.md), tensorflow kernels `tf 2.15.0` and `tf 2.14.0` are available.
