...
-   ### **HPC Helpdesk**
    ...
    - :material-email: HPC Email Support: <a href="mailto:scienceithelp@lbl.gov">scienceithelp@lbl.gov</a> (Creates a ticket in Freshservice)
    - :simple-helpdesk: Freshservice Ticket Request: <a href="https://lbl.freshservice.com/a/tickets/new">HPC Help Request</a> (Choose ScienceIT Workspace)
