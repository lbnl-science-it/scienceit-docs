...
The performance analysis tool NVIDIA [Nsight Systems](https://developer.nvidia.com/nsight-systems){:target="_blank"} is part of the CUDA Toolkit. For example once `gcc/11.4.0` and `cuda/12.8.0` are loaded as shown above, you can use the `nsys` executable.
