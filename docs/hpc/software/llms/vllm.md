...
[vLLM](https://github.com/vllm-project/vllm){:target="_blank"} {{ ext }} is provided as a module on Lawrencium and can be used to run various open-weight Large-Language Models (LLMs) on Lawrencium hardware. 
...
Please follow the official [vLLM documentation](https://docs.vllm.ai/en/v0.19.0/getting_started/quickstart/){:target="_blank"} {{ ext }} on how to make use of vLLM through OpenAI-compatible server or through batch inferencing.
