...
Lawrencium consists of multiple generations of compute nodes with the `lr7` partition being the most recent addition and the `lr7` partition the oldest still in production. Below are the current partitions in production.
